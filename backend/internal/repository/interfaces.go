...
type IncidentRepository interface {
	...
	// GetOpenByDeviceID returns the single ACTIVE (unresolved) incident for a device, or nil if none exists.
	GetOpenByDeviceID(deviceID string) (*domain.Incident, error)
